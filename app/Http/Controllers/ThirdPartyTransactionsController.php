    ...
    public function getGraphData(Request $request) {
        ...
        $data = DB::connection('sqlsrv')
            ...
            ->select(
                ...
                DB::raw("(SELECT SUM(TotalAmount) FROM ThirdPartyTransactions WHERE Company=ThirdPartyTransactions.Company AND TRY_CAST(created_at AS DATE)='" . $joined . "-01') AS Data01"),
                DB::raw("(SELECT SUM(TotalAmount) FROM ThirdPartyTransactions WHERE Company=ThirdPartyTransactions.Company AND TRY_CAST(created_at AS DATE)='" . $joined . "-02') AS Data02"),
                DB::raw("(SELECT SUM(TotalAmount) FROM ThirdPartyTransactions WHERE Company=ThirdPartyTransactions.Company AND TRY_CAST(created_at AS DATE)='" . $joined . "-03') AS Data03"),
                DB::raw("(SELECT SUM(TotalAmount) FROM ThirdPartyTransactions WHERE Company=ThirdPartyTransactions.Company AND TRY_CAST(created_at AS DATE)='" . $joined . "-04') AS Data04"),
                DB::raw("(SELECT SUM(TotalAmount) FROM ThirdPartyTransactions WHERE Company=ThirdPartyTransactions.Company AND TRY_CAST(created_at AS DATE)='" . $joined . "-05') AS Data05"),
                DB::raw("(SELECT SUM(TotalAmount) FROM ThirdPartyTransactions WHERE Company=ThirdPartyTransactions.Company AND TRY_CAST(created_at AS DATE)='" . $joined . "-06') AS Data06"),
                DB::raw("(SELECT SUM(TotalAmount) FROM ThirdPartyTransactions WHERE Company=ThirdPartyTransactions.Company AND TRY_CAST(created_at AS DATE)='" . $joined . "-07') AS Data07"),
                DB::raw("(SELECT SUM(TotalAmount) FROM ThirdPartyTransactions WHERE Company=ThirdPartyTransactions.Company AND TRY_CAST(created_at AS DATE)='" . $joined . "-08') AS Data08"),
                DB::raw("(SELECT SUM(TotalAmount) FROM ThirdPartyTransactions WHERE Company=ThirdPartyTransactions.Company AND TRY_CAST(created_at AS DATE)='" . $joined . "-09') AS Data09"),
                DB::raw("(SELECT SUM(TotalAmount) FROM ThirdPartyTransactions WHERE Company=ThirdPartyTransactions.Company AND TRY_CAST(created_at AS DATE)='" . $joined . "-10') AS Data10"),
                DB::raw("(SELECT SUM(TotalAmount) FROM ThirdPartyTransactions WHERE Company=ThirdPartyTransactions.Company AND TRY_CAST(created_at AS DATE)='" . $joined . "-11') AS Data11"),
                DB::raw("(SELECT SUM(TotalAmount) FROM ThirdPartyTransactions WHERE Company=ThirdPartyTransactions.Company AND TRY_CAST(created_at AS DATE)='" . $joined . "-12') AS Data12"),
                DB::raw("(SELECT SUM(TotalAmount) FROM ThirdPartyTransactions WHERE Company=ThirdPartyTransactions.Company AND TRY_CAST(created_at AS DATE)='" . $joined . "-13') AS Data13"),
                DB::raw("(SELECT SUM(TotalAmount) FROM ThirdPartyTransactions WHERE Company=ThirdPartyTransactions.Company AND TRY_CAST(created_at AS DATE)='" . $joined . "-14') AS Data14"),
                DB::raw("(SELECT SUM(TotalAmount) FROM ThirdPartyTransactions WHERE Company=ThirdPartyTransactions.Company AND TRY_CAST(created_at AS DATE)='" . $joined . "-15') AS Data15"),
                DB::raw("(SELECT SUM(TotalAmount) FROM ThirdPartyTransactions WHERE Company=ThirdPartyTransactions.Company AND TRY_CAST(created_at AS DATE)='" . $joined . "-16') AS Data16"),
                DB::raw("(SELECT SUM(TotalAmount) FROM ThirdPartyTransactions WHERE Company=ThirdPartyTransactions.Company AND TRY_CAST(created_at AS DATE)='" . $joined . "-17') AS Data17"),
                DB::raw("(SELECT SUM(TotalAmount) FROM ThirdPartyTransactions WHERE Company=ThirdPartyTransactions.Company AND TRY_CAST(created_at AS DATE)='" . $joined . "-18') AS Data18"),
                DB::raw("(SELECT SUM(TotalAmount) FROM ThirdPartyTransactions WHERE Company=ThirdPartyTransactions.Company AND TRY_CAST(created_at AS DATE)='" . $joined . "-19') AS Data19"),
                DB::raw("(SELECT SUM(TotalAmount) FROM ThirdPartyTransactions WHERE Company=ThirdPartyTransactions.Company AND TRY_CAST(created_at AS DATE)='" . $joined . "-20') AS Data20"),
                DB::raw("(SELECT SUM(TotalAmount) FROM ThirdPartyTransactions WHERE Company=ThirdPartyTransactions.Company AND TRY_CAST(created_at AS DATE)='" . $joined . "-21') AS Data21"),
                DB::raw("(SELECT SUM(TotalAmount) FROM ThirdPartyTransactions WHERE Company=ThirdPartyTransactions.Company AND TRY_CAST(created_at AS DATE)='" . $joined . "-22') AS Data22"),
                DB::raw("(SELECT SUM(TotalAmount) FROM ThirdPartyTransactions WHERE Company=ThirdPartyTransactions.Company AND TRY_CAST(created_at AS DATE)='" . $joined . "-23') AS Data23"),
                DB::raw("(SELECT SUM(TotalAmount) FROM ThirdPartyTransactions WHERE Company=ThirdPartyTransactions.Company AND TRY_CAST(created_at AS DATE)='" . $joined . "-24') AS Data24"),
