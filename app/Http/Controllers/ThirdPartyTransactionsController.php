        ...
        if ($company == 'All') {
            $data = DB::connection('sqlsrv')
                ...
                ->select(
                    ...
                    DB::raw("(SELECT COUNT(a.TotalAmount) FROM ThirdPartyTransactions a WHERE a.Company=ThirdPartyTransactions.Company AND TRY_CAST(a.created_at AS DATE) BETWEEN '" . $year . "-01-01' AND '" . ThirdPartyTransactions::getLastDayOf('January', $year) . "') AS JanuaryCount"),
                    DB::raw("(SELECT COUNT(a.TotalAmount) FROM ThirdPartyTransactions a WHERE a.Company=ThirdPartyTransactions.Company AND TRY_CAST(a.created_at AS DATE) BETWEEN '" . $year . "-02-01' AND '" . ThirdPartyTransactions::getLastDayOf('February', $year) . "') AS FebruaryCount"),
                    DB::raw("(SELECT COUNT(a.TotalAmount) FROM ThirdPartyTransactions a WHERE a.Company=ThirdPartyTransactions.Company AND TRY_CAST(a.created_at AS DATE) BETWEEN '" . $year . "-03-01' AND '" . ThirdPartyTransactions::getLastDayOf('March', $year) . "') AS MarchCount"),
                    DB::raw("(SELECT COUNT(a.TotalAmount) FROM ThirdPartyTransactions a WHERE a.Company=ThirdPartyTransactions.Company AND TRY_CAST(a.created_at AS DATE) BETWEEN '" . $year . "-04-01' AND '" . ThirdPartyTransactions::getLastDayOf('April', $year) . "') AS AprilCount"),
                    DB::raw("(SELECT COUNT(a.TotalAmount) FROM ThirdPartyTransactions a WHERE a.Company=ThirdPartyTransactions.Company AND TRY_CAST(a.created_at AS DATE) BETWEEN '" . $year . "-05-01' AND '" . ThirdPartyTransactions::getLastDayOf('May', $year) . "') AS MayCount"),
                    DB::raw("(SELECT COUNT(a.TotalAmount) FROM ThirdPartyTransactions a WHERE a.Company=ThirdPartyTransactions.Company AND TRY_CAST(a.created_at AS DATE) BETWEEN '" . $year . "-06-01' AND '" . ThirdPartyTransactions::getLastDayOf('June', $year) . "') AS JuneCount"),
                    DB::raw("(SELECT COUNT(a.TotalAmount) FROM ThirdPartyTransactions a WHERE a.Company=ThirdPartyTransactions.Company AND TRY_CAST(a.created_at AS DATE) BETWEEN '" . $year . "-07-01' AND '" . ThirdPartyTransactions::getLastDayOf('July', $year) . "') AS JulyCount"),
                    DB::raw("(SELECT COUNT(a.TotalAmount) FROM ThirdPartyTransactions a WHERE a.Company=ThirdPartyTransactions.Company AND TRY_CAST(a.created_at AS DATE) BETWEEN '" . $year . "-08-01' AND '" . ThirdPartyTransactions::getLastDayOf('August', $year) . "') AS AugustCount"),
                    DB::raw("(SELECT COUNT(a.TotalAmount) FROM ThirdPartyTransactions a WHERE a.Company=ThirdPartyTransactions.Company AND TRY_CAST(a.created_at AS DATE) BETWEEN '" . $year . "-09-01' AND '" . ThirdPartyTransactions::getLastDayOf('September', $year) . "') AS SeptemberCount"),
                    DB::raw("(SELECT COUNT(a.TotalAmount) FROM ThirdPartyTransactions a WHERE a.Company=ThirdPartyTransactions.Company AND TRY_CAST(a.created_at AS DATE) BETWEEN '" . $year . "-10-01' AND '" . ThirdPartyTransactions::getLastDayOf('October', $year) . "') AS OctoberCount"),
                    DB::raw("(SELECT COUNT(a.TotalAmount) FROM ThirdPartyTransactions a WHERE a.Company=ThirdPartyTransactions.Company AND TRY_CAST(a.created_at AS DATE) BETWEEN '" . $year . "-11-01' AND '" . ThirdPartyTransactions::getLastDayOf('November', $year) . "') AS NovemberCount"),
                    DB::raw("(SELECT COUNT(a.TotalAmount) FROM ThirdPartyTransactions a WHERE a.Company=ThirdPartyTransactions.Company AND TRY_CAST(a.created_at AS DATE) BETWEEN '" . $year . "-12-01' AND '" . ThirdPartyTransactions::getLastDayOf('December', $year) . "') AS DecemberCount"),
                )
                ->groupBy('Company')
                ->get();
        } else {
